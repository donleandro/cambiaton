...
<svelte:head><title>Registro · Álbum 2026</title></svelte:head>
...
<div class="grid min-h-screen place-items-center bg-stone-50 p-4">
	<div class="w-full max-w-sm rounded-xl border border-stone-200 bg-white p-6 shadow-sm">
		<h1 class="text-xl font-bold tracking-tight">Crear cuenta</h1>
		<p class="mt-1 text-sm text-stone-600">
			Tu colección va a empezar vacía. Después de registrarte podés marcar tus stickers
			directamente o pegar tu lista en /compartir.
		</p>
		...
		<div class="mt-6 border-t border-stone-100 pt-4 text-center text-sm">
			<a href="/login" class="text-stone-600 hover:underline">Ya tengo cuenta</a>
		</div>
	</div>
</div>
